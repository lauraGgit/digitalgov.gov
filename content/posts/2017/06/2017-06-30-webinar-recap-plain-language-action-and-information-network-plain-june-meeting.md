  ...
  <tr>
    <td style="vertical-align: top;text-align: center">
      ...
      <p>
        ...
        <p>
          <em>If you have a <strong>.gov</strong> or <strong>.mil</strong> email address, consider joining one of our <a href="{{< link "/communities/" >}}">Communities</a>, such as the <a href="{{< link "plain-language-community-of-practice.md" >}}">Plain Language Community of Practice</a>, the <a href="{{< link "web-content-managers.md" >}}">Web Content Managers Forum</a>, the <a href="{{< link "multilingual.md" >}}">Multilingual Community of Practice</a>, or the <a href="{{< link "web-content-managers.md" >}}">Web Content Managers Forum</a>.</em>
        </p>
